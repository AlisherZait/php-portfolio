...
body {
  ...
  background-image: url(../../../media/Img/trenzaitgl.jpg);
    background-size:100%;
}
th, td {
  padding: 20px;
...
<ul id="navbar" style="margin-left: 700px; margin-right:50px;" >
    ...
    <h1 style="color:#aaa;margin-left: -10px">Список Зайт Алишерa</h1>
            ...
            foreach ($trainer1 as $trainer1) {
                ?>
                    <tr>
                        ...
                        <td><a href="update.php?id=<?= $trainer1[0] ?>">Изменить</a></td>
                        <td><a style="color: red;" href="delete.php?id=<?=  $trainer1[0] ?>">Удалить</a></td>
                    </tr>
                <?php
            }
        ?>
