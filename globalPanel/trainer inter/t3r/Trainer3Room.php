...
body {
  ...
  background-image: url(../../../media/Img/trendamgl.jpg);
  background-size:100%;
}
th, td {
  padding: 20px;
...
<ul id="navbar" style="margin-left: 700px; margin-right:50px;" >
      ...
      <li><a href="#">трен клиент</a>
        ...
        <li><a href="../t1r/Trainer1Room.php">Зайт Алишер</a></li>
          <li><a href="../t2r/Trainer2Room.php">Аманкелды Диана</a> <li>
          <li><a href="#">Мусаханов Дамир</a> <li>
    ...
    <h1 style="color:#aaa;margin-left: -10px">Список Мусаханова Дамира</h1>
...
if(isset($_POST['search']))
{
    ...
    $query="SELECT*FROM trainer3 WHERE full_name='$full_name'";
...
<div class="table">
    <table>
        ...
        <?php
            ...
            $trainer3 = mysqli_query($connect, "SELECT * FROM `trainer3`");

            /*
             * Преобразовываем полученные данные в нормальный массив
             */

            $trainer3 = mysqli_fetch_all($trainer3);
            ...
            foreach ($trainer3 as $trainer3) {
                ?>
                    <tr>
                        ...
                        <td><a href="update.php?id=<?= $trainer3[0] ?>">Изменить</a></td>
                        <td><a style="color: red;" href="delete.php?id=<?=  $trainer3[0] ?>">Удалить</a></td>
                    </tr>
                <?php
            }
        ?>
